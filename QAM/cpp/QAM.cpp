...
PREPARE_LOGGING(QAM_i)

QAM_i::QAM_i(const char *uuid, const char *label) :
    QAM_base(uuid, label)
{
...
void QAM_i::bitRateChanged(const unsigned short *oldVal, const unsigned short *newVal)
{
...
/***********************************************************************************************
    ...
    Properties:
        ...
        addPropertyChangeListener(<property name>, this, &QAM_i::<callback method>)
        in the constructor.
        ...
        QAM_i::QAM_i(const char *uuid, const char *label) :
            QAM_base(uuid, label)
        {
            addPropertyChangeListener("scaleValue", this, &QAM_i::scaleChanged);
        }

        void QAM_i::scaleChanged(const float *oldValue, const float *newValue)
        {
...
void QAM_i::createModem(void)
{
	...
	switch(bitRate){
		case 4: qam_modem = modem_create(LIQUID_MODEM_QAM4); break;
		case 8: qam_modem = modem_create(LIQUID_MODEM_QAM8); break;
		case 16: qam_modem = modem_create(LIQUID_MODEM_QAM16); break;
		case 32: qam_modem = modem_create(LIQUID_MODEM_QAM32); break;
		case 64: qam_modem = modem_create(LIQUID_MODEM_QAM64); break;
		case 128: qam_modem = modem_create(LIQUID_MODEM_QAM128); break;
		case 256: qam_modem = modem_create(LIQUID_MODEM_QAM256); break;
	}
}
